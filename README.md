...
4. **Run unit tests:**
   ...
   ```
    *(Executes 1084 unit/contract tests across P-05 domain contracts, P-06.03/P-06.04 controls, P-07 agent fleet and coordination, and P-08/P-09 boundary tests with exit code 0; one ADK deprecation warning is recorded.)*
...
|---|---|---|---|
| `uv run python scripts/cmd.py unit` | Run unit tests | Local deterministic test execution | `PASS` (1084 passed, 1 warning) |
