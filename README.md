...
- **Target enterprise services, subject to real access:** Agent Runtime, Memory Bank, Agent Registry, Agent Identity, Agent Gateway, Model Armor, Agent Observability
