...
| Pub/Sub event backbone | IN_PROGRESS — P-09.01 topology implemented (`events/topology.py`, `events/topology_manifest.json`, `docs/diagrams/pubsub_topology.md`); adapters P-09.02+ pending |
