# ChangeMesh Four-Minute Demo Script

Status: `PLANNED — validate timing against final app`

## 0:00–0:25 — Problem/value
Show one goal and cross-system impact; promise autonomous work, exception-only authority, evidence.

## 0:25–0:55 — Discover/qualify
Show two revisions; reject invalid Capability Passport; select proven revision.

## 0:55–1:35 — Parallel impact/policy
...
## 3:15–3:35 — Approval Compression
