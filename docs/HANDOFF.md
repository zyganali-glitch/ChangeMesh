...
**Active Task:**
- P-27.04 — Test quota/rate-limit degradation (PENDING)

## Current P-27 State (P-27.03 Budget & Retention Config Completed)
...
- **P-27.04:** `PENDING` — Test quota/rate-limit degradation (Next eligible micro-task).
