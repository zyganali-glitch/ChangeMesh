...
4. **Birim testleri çalıştırın:**
   ...
   ```
   *(P-05 kontratları, P-06 kontrolleri, P-07 ajan filosu/koordinasyonu ve P-08.01/P-08.02/P-08.03/P-08.04 Gemini sınır testleri dahil 1017 testi 0 çıkış koduyla çalıştırır; bir ADK kullanımdan kaldırma uyarısı kaydedilir).*
...
|---|---|---|---|
| `uv run python scripts/cmd.py unit` | Birim testleri çalıştır | Yerel deterministik test çalıştırma | `PASS` (1017 geçti, 1 uyarı) |
